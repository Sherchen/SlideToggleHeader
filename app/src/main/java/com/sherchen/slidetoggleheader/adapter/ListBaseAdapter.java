package com.sherchen.slidetoggleheader.adapter;
...
import com.sherchen.slidetoggleheader.R;
...
/**
 * 通用的adapter
 * @param <Entity> The data entity class
 * @param <ViewHolder> The ViewHolder class
 */
